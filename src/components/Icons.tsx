 ...
 * Each icon is a lightweight React component (no external dependency).
 */
...
function svgProps({ className, size = defaultSize }: IconProps) {
  return {
...
export const IconTwitter: React.FC<IconProps> = (props) => (
  <svg {...svgProps(props)}>
...
export const IconNewspaper: React.FC<IconProps> = (props) => (
  <svg {...svgProps(props)}>
    <path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3H7v2h5V6zm0 4H7v2h5v-2zm5 0h-3v2h3v-2zm0-4h-3v2h3V6zm-5 8H7v2h5v-2zm5 0h-3v2h3v-2z" />
  </svg>
);
